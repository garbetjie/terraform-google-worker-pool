...
ExecStart=/usr/bin/docker run --rm --name cloudsql --label part-of=cloudsql -v cloudsql:/cloudsql gcr.io/cloudsql-docker/gce-proxy:1.19.1-alpine ./cloud_sql_proxy -dir /cloudsql -instances ${join(",", connections)}
